...
function resolveCitySlug(location: string, searchCity: CitySlug): string {
  ...
  return byLabel?.slug ?? searchCity;
}
...
export function HomeownersLead() {
  ...
  const [searchCity, setSearchCity] = useState<CitySlug>(defaultCitySlug);
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await uploadOwnerLead({
      ...
      phone,
      email: "",
      // Prefer a known city slug when possible; otherwise keep the search city.
      city: resolveCitySlug(location, searchCity),
                ...
                <>
                  ...
                  >
                    ...
                    <div className="block space-y-1.5">
                      <label htmlFor="homeowners-location">
                        <FieldLabel>Location</FieldLabel>
                      </label>
                      <LocationSuggestField
                        id="homeowners-location"
                        name="location"
                        value={location}
                        city={searchCity}
